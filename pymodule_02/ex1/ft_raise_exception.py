def input_temp(temperature: str) -> int:
    ...
    if int_temperature < 0:
        raise ValueError(f'{int_temperature}°C is too cold for plants (min 0°C)')
    elif int_temperature > 40:
        raise ValueError(f'{int_temperature}°C is too hot for plants (max 40°C)')
